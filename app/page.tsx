...
export default function Home() {
  ...
  const [selectedOption, setSelectedOption] = useState('EVM');
  ...
  return (
    <div className='overflow-x-hidden'>
      ...
      <div className='px-8 xl:px-96'>
        ...
        >
          <span className={`${PoppinsFont.className}`}>Send Gift / $TIP</span>
        ...
        <div className='pt-9 flex flex-col items-center'>
          <div className='flex flex-col items-center'>
            <img src="https://buatlogoonline.com/wp-content/uploads/2022/10/Logo-Bank-BRI.png" alt="BRI Logo" className='w-44'/>
            <h1 className='font-bold pt-3 text-center'>548901000617509 - AN WAHYU ZULFIRMAN</h1>
          </div>

          <div className='pt-5 flex flex-col items-center'>
            <img src="https://jasalogocepat.com/wp-content/uploads/2023/09/Logo-Bank-BCA-PNG-Transparan-jasalogocepat.png" className='w-44' alt="BCA Logo" />
            <h1 className='font-bold pt-3 text-center'>8180413112 AN NAFA FATMA</h1>
          </div>
        </div>
